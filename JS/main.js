function draw_cuadrado() {
    const canvas = document.getElementById("Canvas_Forma_Rectangular");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
        
      ctx.fillStyle = 'rgb(187,83,196)';
  ...
  function draw_mover_pluma() {
      const canvas = document.getElementById("Canvas_Mover_La_Pluma");
      if (canvas.getContext) {
        const ctx = canvas.getContext("2d");
  ...
  function draw_bezier_c() {
    const canvas = document.getElementById("Canvas_Curvas_Cuadraticas_Bézier");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_bezier_cubicas() {
    const canvas = document.getElementById("Canvas_Curvas_Cubicas_Bézier");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_formas() {
    const canvas = document.getElementById("Canvas_Formas_y_Agujeros");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_path_2d() {
    const canvas = document.getElementById("Canvas_Path_2D");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
